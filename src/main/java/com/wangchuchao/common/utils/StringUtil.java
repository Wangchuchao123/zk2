...
public class StringUtil {
	 ...
	 * @Description: 返回参数length个中文汉字字符串，字符集必须在GB2312
	 * @param length
	 * @return
	 * @return: String
	 */
	...
	public static String generateChineseName(){
		...
		String name="";
		name=str[RandomUtil.random(0, str.length-1)]+StringUtil.randomChineseString(RandomUtil.random(1, 2));
